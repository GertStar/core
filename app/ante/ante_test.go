...
func createTestApp(isCheckTx bool, tempDir string) (*GertApp.GertApp, sdk.Context) {
	app := GertApp.NewGertApp(
		log.NewNopLogger(), dbm.NewMemDB(), nil, true, map[int64]bool{},
		tempDir, simapp.FlagPeriodValue, GertApp.MakeEncodingConfig(),
