...
import (
	...
	customtx "github.com/Gert-Chain/core/app/tx"
	...
	GertAppparams "github.com/Gert-Chain/core/app/params"
	"github.com/Gert-Chain/core/app/wasmconfig"

	// unnamed import of statik for swagger UI support
	_ "github.com/Gert-Chain/core/client/docs/statik"
)
...
var (
	_ servertypes.Application = (*GertApp)(nil)
)
...
// GertApp extends an ABCI application, but with most of its parameters exported.
...
// NewGertApp returns a reference to an initialized gert.
func NewGertApp(
	logger log.Logger,
	db dbm.DB,
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig GertAppparams.EncodingConfig,
...
func (app *GertApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *GertApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *GertApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *GertApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *GertApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *GertApp) ModuleAccountAddrs() map[string]bool {
...
func (app *GertApp) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns gert's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *GertApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns gert's InterfaceRegistry
func (app *GertApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *GertApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *GertApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *GertApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *GertApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *GertApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *GertApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *GertApp) RegisterTendermintService(clientCtx client.Context) {
	tmservice.RegisterTendermintService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.interfaceRegistry)
}

// RegisterUpgradeHandlers returns upgrade handlers
func (app *GertApp) RegisterUpgradeHandlers(cfg module.Configurator) {}
...
func (app *GertApp) enforceStakingForVestingTokens(ctx sdk.Context, genesisState GenesisState) {
